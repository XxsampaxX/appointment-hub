...
import { CalendarDays, User, Phone, KeyRound, Mail, Loader2 } from "lucide-react";
      ...
      <Card className="w-full max-w-md shadow-lg border-border/50 animate-fade-in">
        ...
        <CardContent>
          <form onSubmit={handleSubmit} className="space-y-4">
            <div className="space-y-2">
              ...
              <div className="relative">
                ...
                <Input id="name" placeholder="Seu nome completo" value={name} onChange={(e) => setName(e.target.value)} className="pl-10" required disabled={submitting} />
              </div>
            </div>
            <div className="space-y-2">
            ...
            <div className="space-y-2">
              ...
              <div className="relative">
                ...
                <Input id="phone" type="tel" placeholder="(11) 99999-9999" value={phone} onChange={(e) => setPhone(maskPhone(e.target.value))} className="pl-10" required disabled={submitting} />
              </div>
            </div>
            <div className="space-y-2">
          ...
          <div className="mt-4 text-center">
            <Link to="/"><Button variant="link">Já tenho conta — Entrar</Button></Link>
          </div>
        </CardContent>
      </Card>
    </div>
